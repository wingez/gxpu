...
A compiler from a python-like language to machinecode for the [gcpu](https://drive.google.com/drive/folders/1EAVSUdtXN2XQuCqYHWJUCzu0Gr4t_KcM?usp=sharing) microcomputer
I dont know what im doing, just trying things out and learning on the way.

To best get an overview of what's possible to do with the language so far check out the tests in /tests/everything/programs which uses all parts of the language
